                        ...
                        <Accordion type="single" collapsible className="w-full">
                            <AccordionItem value="faq-what-is-qr" id="faq-what-is-qr">
                                <AccordionTrigger className="text-left hover:no-underline">
                                    Qu'est-ce un QR Code ? Définition et Fonctionnement
                                </AccordionTrigger>
                            ...
                            <AccordionItem value="faq-static-vs-dynamic" id="faq-static-vs-dynamic">
                                ...
                                <AccordionContent className="text-slate-600 leading-relaxed space-y-3">
                                    <div>
                                        <strong className="text-slate-900">QR Code Statique :</strong> L'information est encodée directement dans le code. Une fois généré, le contenu ne peut pas être modifié. Idéal pour des informations permanentes (carte de visite, menu, etc.).
                                    </div>
                                    <div>
                                        <strong className="text-slate-900">QR Code Dynamique :</strong> Le QR Code contient un lien court qui redirige vers une URL modifiable. Vous pouvez changer la destination sans regénérer le code. Il permet également de suivre les statistiques de scan (nombre de scans, localisation, appareil utilisé).
                                    </div>
                        ...
                        <Accordion type="single" collapsible className="w-full">
                            ...
                            <AccordionItem value="custom-4">
                                ...
                                <AccordionContent className="text-slate-600 leading-relaxed space-y-3">
                                    ...
                                    <div>
                                        <strong className="text-slate-900">Forme des points :</strong>
                                    ...
                                    <div>
                                        <strong className="text-slate-900">Forme des coins :</strong>
                                        <ul className="list-disc list-inside mt-1 space-y-1 ml-4">
                    ...
                    <CardContent className="p-6">
                        <Accordion type="single" collapsible className="w-full">
                            <AccordionItem value="terms-1">
                                ...
                                <AccordionContent className="text-slate-600 leading-relaxed space-y-3">
                                    <div>
                                        <strong className="text-slate-900">Collecte de données :</strong> Notre plateforme respecte votre vie privée. Nous ne collectons aucune donnée personnelle lors de l'utilisation du générateur de QR Code. Les QR Codes sont générés localement ou sur notre serveur puis immédiatement supprimés.
                                    </div>
                                    <div>
                                        <strong className="text-slate-900">Fichiers uploadés :</strong> Les fichiers PDF ou images que vous uploadez sont stockés temporairement pour générer le QR Code, puis automatiquement supprimés après 24 heures.
                                    </div>
                                    <div>
                                        <strong className="text-slate-900">Cookies et Publicité :</strong> Nous utilisons des cookies techniques nécessaires au bon fonctionnement du site. En outre, nous faisons appel à des régies publicitaires tierces, notamment Google AdSense, pour diffuser des annonces lorsque vous visitez notre site Web. Ces entreprises peuvent utiliser des données relatives à votre navigation sur notre site Web ou d'autres sites (à l'exception de votre nom, adresse postale, adresse e-mail ou numéro de téléphone) afin de vous proposer des annonces de produits ou services adaptées à vos centres d'intérêt (Cookies publicitaires et de tracking).
                                    </div>
                                    <div>
                                        <strong className="text-slate-900">Vos droits (RGPD) :</strong> Conformément à la réglementation européenne, vous avez la possibilité d'accepter ou de refuser ces cookies publicitaires lors de votre première visite via notre bannière de consentement, et de modifier ce choix à tout moment.
                                    </div>
                                </AccordionContent>
                            </AccordionItem>
                            ...
                            <AccordionItem value="terms-3">
                                ...
                                <AccordionContent className="text-slate-600 leading-relaxed">
                                    <div>
                                        <strong className="text-slate-900">Vos QR Codes :</strong> Les QR Codes que vous générez vous appartiennent. Vous êtes libre de les utiliser à des fins personnelles ou commerciales sans limitation.
                                    </div>
                                    <div className="mt-3">
                                        <strong className="text-slate-900">Notre plateforme :</strong> Le code source, le design et la marque de notre générateur de QR Code sont protégés par les lois sur la propriété intellectuelle. Toute reproduction ou modification non autorisée est interdite.
                                    </div>
                                </AccordionContent>
                            </AccordionItem>
