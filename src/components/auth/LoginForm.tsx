...
import { login, setToken, setUser, type LoginData, type User } from "@/lib/auth"
                        ...
                        <div className="grid gap-6">
                            <div className="flex flex-col gap-4">
                                ...
                                <Button variant="outline" type="button" className="w-full" onClick={() => {
                                    window.location.href = `${import.meta.env.VITE_API_URL || "http://127.0.0.1:8000"}/api/v1/auth/google`
                                }}>
                                    <svg className="mr-2 h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <div className="text-center text-sm">
                                ...
                                <a href="#" onClick={(e) => { e.preventDefault(); onSwitchToRegister(); }} className="underline underline-offset-4">
                                    S'inscrire
                                </a>
                            </div>
                        </div>
